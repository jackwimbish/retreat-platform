# Volto - Retreat Experience Platform
...
## 🚀 Quick Start - Build & Run Development Server

```bash
# Clone the repository
git clone <repository-url>
cd my-retreat-platform/frontend
...
> **Prerequisites**: Make sure you have Node.js (v18.x recommended) and Yarn installed on your system.
